...
namespace vkb
{
    ...
    template <typename HandleType>
    inline typename Allocated<HandleType>::BufferType Allocated<HandleType>::create_buffer(
    ...
    template <typename HandleType>
    inline typename Allocated<HandleType>::ImageType Allocated<HandleType>::create_image(
