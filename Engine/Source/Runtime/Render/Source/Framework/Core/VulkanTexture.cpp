...
namespace vks
{
                                 ...
                                 VkImageUsageFlags imageUsageFlags, VkImageLayout imageLayout, bool forceLinear)
    {
        ...
        else
        {
            ...
            vks::tools::setImageLayout(copyCmd, image, VK_IMAGE_ASPECT_COLOR_BIT, VK_IMAGE_LAYOUT_UNDEFINED,
                                       imageLayout);
    ...
    {
        int texChannels;
        stbi_uc *pixels = stbi_load(filename.c_str(), reinterpret_cast<int *>(&width), reinterpret_cast<int *>(&height),
