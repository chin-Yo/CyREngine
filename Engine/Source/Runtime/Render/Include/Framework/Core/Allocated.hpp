...
namespace vkb
{
	...
	template <typename HandleType>
	inline Allocated<HandleType>::Allocated(Allocated &&other) noexcept : ParentType{static_cast<ParentType &&>(other)},
	...
	template <typename HandleType>
	template <typename... Args>
	inline Allocated<HandleType>::Allocated(const VmaAllocationCreateInfo &allocation_create_info, Args &&...args) : ParentType{std::forward<Args>(args)...},
																													 allocation_create_info(allocation_create_info)
	{
	}

	template <typename HandleType>
	inline Allocated<HandleType>::Allocated(HandleType handle, DeviceType *device_) : ParentType(handle, device_)
	{
	}
	...
	template <typename HandleType>
	inline typename Allocated<HandleType>::BufferType Allocated<HandleType>::create_buffer(BufferCreateInfoType const &create_info)
	{
	...
	template <typename HandleType>
	inline typename Allocated<HandleType>::ImageType Allocated<HandleType>::create_image(ImageCreateInfoType const &create_info)
	{
	...
	template <typename HandleType>
	inline void Allocated<HandleType>::destroy_buffer(BufferType handle)
	{
	...
	template <typename HandleType>
	inline void Allocated<HandleType>::destroy_image(ImageType image)
	{
	...
	template <typename HandleType>
	inline void Allocated<HandleType>::flush(DeviceSizeType offset, DeviceSizeType size)
	{
		if (!coherent)
		{
	...
	template <typename HandleType>
	inline typename Allocated<HandleType>::DeviceMemoryType Allocated<HandleType>::get_memory() const
	{
