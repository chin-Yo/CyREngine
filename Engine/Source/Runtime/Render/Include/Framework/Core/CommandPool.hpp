...
// 假设此头文件现在定义了 vkb::VulkanDevice 类
// 并且可能已被重命名和移动，例如 #include "vkb/vulkan_device.h"
...
namespace vkb
{
    ...
    public:
        ...
        std::shared_ptr<vkb::CommandBuffer> request_command_buffer(VkCommandBufferLevel level = VK_COMMAND_BUFFER_LEVEL_PRIMARY);
        ...
        std::shared_ptr<vkb::CommandBuffer> request_command_buffer(vkb::CommandPool &commandPool, VkCommandBufferLevel level);
        void reset_pool();
