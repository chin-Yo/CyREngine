...
void UIOverlay::InitImGui(VkInstance instance, VkRenderPass renderPass, VkQueue queue, uint32_t MinImageCount, uint32_t ImageCount)
{
...
void UIOverlay::RenderHierarchy()
{
...
void UIOverlay::RenderInspector()
{
...
void UIOverlay::RenderProjectBrowser()
{
...
void UIOverlay::RenderViewport()
{
	...
	ImGui::GetWindowDrawList()->AddRectFilled(
		...
		ImVec2(ImGui::GetCursorScreenPos().x + currentViewportSize.x, ImGui::GetCursorScreenPos().y + currentViewportSize.y),
		IM_COL32(0, 0, 0, 255));
	ImGui::SetCursorPos(ImVec2(currentViewportSize.x * 0.5f - 100, currentViewportSize.y * 0.5f));
